function solve() {
   ...
   const bestTrstaurantInfo = document.querySelector("#bestRestaurant p")
   const bestTrstaurantWorkers = document.querySelector("#workers p")
   ...
   function appendBestRestaurantWorkersInfo(workers) {
      ...
      bestTrstaurantWorkers.textContent = buff;
   }

   function appendBestRestaurantInfo(data) {
      bestTrstaurantInfo.textContent = `Name: ${data[0]} Average Salary: ${data[1].avgSalary.toFixed(2)} Best Salary: ${data[1].bestSalary.toFixed(2)}`;
   }
